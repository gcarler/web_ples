...
export default function Home() {
  ...
  const t = useTranslations('HomePage');
   ...
   const heroStatements: HeroStatement[] = [
      {
        title: t('heroStatements.0.title'),
        description: t('heroStatements.0.description'),
        ctaText: t('heroStatements.0.ctaText'),
        ctaLink: "/forms",
        ctaIconName: "Send",
        ctaVariant: 'accent',
        order: 1,
      ...
      {
        title: t('heroStatements.1.title'),
        description: t('heroStatements.1.description'),
        ctaText: t('heroStatements.1.ctaText'),
      ...
      {
        title: t('heroStatements.2.title'),
        description: t('heroStatements.2.description'),
        ctaText: t('heroStatements.2.ctaText'),
