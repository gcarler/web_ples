// src/app/[locale]/ples-catastro/levantamiento-predial/page.tsx
'use client'
...
const serviceDetails = {
  ...
  keyServices: [ 
    { title: 'Cobertura Exhaustiva', text: 'Levantamientos detallados en zonas urbanas y rurales, adaptados a las particularidades de cada territorio.', icon: Globe },
    { title: 'Tecnología de Precisión', text: 'Uso de GPS RTK/PPK, drones con sensores LiDAR/Fotogramétricos y estaciones totales robóticas para máxima exactitud.', icon: Cpu },
    { title: 'Integración SIG', text: 'Compatibilidad nativa con Sistemas de Información Geográfica (SIG) y Bases de Datos Espaciales para una gestión eficiente.', icon: Layers },
    { title: 'Soporte a la Formalización', text: 'Asesoría técnica y metodológica para la formalización de la propiedad y regularización de la tenencia de la tierra.', icon: DraftingCompass },
  ],
  ...
  benefits: [
    { icon: BarChart3, title: "Base Catastral Precisa", text: "Fundamento sólido para la toma de decisiones estratégicas y gestión territorial." },
    { icon: ShieldCheck, title: "Seguridad Jurídica", text: "Facilita la formalización, reduce conflictos y optimiza la recaudación." },
          ...
          <section className="mb-16">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
              {serviceDetails.methodology.map((item) => {
                ...
                return (
                <Card key={item.title} className="p-6 group transition-all duration-300 ease-in-out hover:shadow-2xl hover:scale-[1.03] hover:border-primary/50 hover:bg-[radial-gradient(circle_at_center,_var(--tw-gradient-stops))] hover:from-primary hover:to-accent hover:animate-gradient hover:bg-[length:200%_200%]">
          ...
          <section className="mb-16">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 md:gap-8">
              {serviceDetails.benefits.map((item) => {
                 const ItemIcon = item.icon;
                 return (
                 <Card key={item.title} className="p-6 group transition-all duration-300 ease-in-out hover:shadow-2xl hover:scale-[1.03] hover:border-primary/50 hover:bg-[radial-gradient(circle_at_center,_var(--tw-gradient-stops))] hover:from-primary hover:to-accent hover:animate-gradient hover:bg-[length:200%_200%] text-center">
