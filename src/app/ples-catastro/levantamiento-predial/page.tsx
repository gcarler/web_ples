          ...
          <section className="mb-16">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
              {serviceDetails.methodology.map((item) => (
                <Card key={item.title} className="p-6 group transition-all duration-300 ease-in-out hover:shadow-2xl hover:scale-[1.03] hover:border-primary/50 hover:bg-primary/5 dark:hover:bg-accent/5">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <CardTitle className="text-lg font-semibold mb-1 text-foreground group-hover:text-primary transition-colors">{item.title}</CardTitle>
                      <p className="text-sm text-muted-foreground group-hover:text-foreground/90 transition-colors">{item.text}</p>
                    </div>
                  </div>
                </Card>
              ))}
