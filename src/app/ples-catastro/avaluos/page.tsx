...
const serviceDetails = {
  ...
  keyServices: [
    { title: 'Modelos de Valoración Automatizada (AVM)', text: 'Desarrollo e implementación de modelos econométricos y algoritmos de IA para la valoración masiva de predios, garantizando eficiencia y consistencia.', icon: <BarChart3 className="h-8 w-8 mb-2 text-primary group-hover:text-accent transition-colors" /> },
    { title: 'Análisis de Mercado Inmobiliario', text: 'Estudios detallados del comportamiento del mercado inmobiliario, identificación de zonas homogéneas físicas y geoeconómicas para fundamentar las valoraciones.', icon: <TrendingUp className="h-8 w-8 mb-2 text-primary group-hover:text-accent transition-colors" /> },
    { title: 'Cumplimiento Normativo y Estándares', text: 'Aplicación de metodologías y normativas vigentes (nacionales e internacionales como IVSC) para asegurar la validez y legalidad de los avalúos.', icon: <ClipboardCheck className="h-8 w-8 mb-2 text-primary group-hover:text-accent transition-colors" /> },
    { title: 'Informes Detallados y Sustentados', text: 'Generación de informes técnicos completos y comprensibles que detallan la metodología, fuentes de información y resultados de la valoración.', icon: <FileText className="h-8 w-8 mb-2 text-primary group-hover:text-accent transition-colors" /> },
  ],
