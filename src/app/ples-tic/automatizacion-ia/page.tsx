...
const serviceDetails = {
  ...
  keyServices: [
    ...
    },
    {
      ...
      text: 'Optimice flujos de trabajo repetitivos mediante Robots de Software (RPA) y la gestión inteligente de procesos (BPA), potenciados con IA para automatizar tareas complejas y la toma de decisiones.',
      icon: Zap
    },
    {
                ...
                <Card key={study.title} className="overflow-hidden shadow-lg border group hover:shadow-2xl transition-all duration-300 ease-in-out hover:border-primary/30">
                  <CardHeader className="bg-muted/30 p-6">
                    <div className="flex items-center gap-3">
                       <StudyIcon className="h-10 w-10 text-primary group-hover:text-accent transition-colors" />
