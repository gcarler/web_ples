...
const serviceDetails = {
  ...
  keyServices: [
    { title: 'Auditorías y Análisis de Vulnerabilidades', text: 'Realizamos pentesting ético y análisis exhaustivos (OWASP, NIST) para identificar y mitigar brechas de seguridad en sus sistemas y aplicaciones.', icon: Fingerprint },
    { title: 'Gestión de Identidad y Acceso (IAM/IGA)', text: 'Implementamos soluciones robustas (MFA, SSO, PAM) para controlar quién accede a qué información, asegurando el principio de mínimo privilegio.', icon: UserCheck },
    { title: 'Seguridad Perimetral y de Endpoints (SOC)', text: 'Desplegamos firewalls de próxima generación (NGFW), EDR, XDR y SIEM para proteger su red, dispositivos y detectar amenazas en tiempo real.', icon: Network },
    { title: 'Respuesta a Incidentes y Continuidad (BCP/DRP)', text: 'Desarrollamos planes de respuesta (IRP), recuperación ante desastres (DRP) y continuidad del negocio (BCP) para minimizar el impacto.', icon: AlertTriangle },
     { title: 'Concientización y Capacitación en Seguridad', text: 'Fortalecemos el eslabón más importante: su personal. Programas de phishing simulado y capacitación continua para crear una cultura de ciberseguridad.', icon: Users },
     { title: 'Consultoría y Cumplimiento Normativo', text: 'Asesoramos en la implementación de marcos de seguridad (ISO 27001, SOC 2) y el cumplimiento de regulaciones (GDPR, HIPAA, PCI DSS).', icon: ShieldQuestion },
  ],
