  ...
  return (
    <div className="py-10 space-y-16">
      ...
      <section className="py-12">
        <div className="w-full max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-bold text-center mb-4 text-transparent bg-clip-text bg-gradient-to-r from-primary to-accent py-1">Nuestros Servicios de Análisis y BI</h2>
      ...
      <section className="py-12 bg-secondary rounded-lg">
        <div className="w-full max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-bold text-center mb-12 text-transparent bg-clip-text bg-gradient-to-r from-primary to-accent py-1">Beneficios de Potenciar su Negocio con Datos</h2>
       ...
       <section className="py-12 bg-card rounded-lg shadow-xl">
        <div className="w-full max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-bold text-center mb-12 text-transparent bg-clip-text bg-gradient-to-r from-primary to-accent py-1">Casos de Éxito en Análisis de Datos</h2>
          <div className="grid md:grid-cols-2 gap-8">
      ...
      <section className="py-12">
        <div className="w-full max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl font-bold mb-4 text-transparent bg-clip-text bg-gradient-to-r from-primary to-accent py-1">Tecnologías y Plataformas de Datos</h2>
