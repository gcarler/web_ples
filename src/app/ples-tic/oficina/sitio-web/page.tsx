...
export default function DeprecatedSitioWebPage() {
  return (
      ...
      <Card className="w-full max-w-md text-center shadow-lg border rounded-lg">
        ...
        <CardContent className="space-y-6">
          <p className="text-muted-foreground">
            Para una mejor experiencia, por favor explora nuestras soluciones directamente en la página principal de PLES TIC.
          </p>
