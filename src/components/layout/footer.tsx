...
export function Footer() {
  return (
    <footer className="relative bg-muted text-muted-foreground pt-12 pb-8 mt-16 overflow-hidden">
      ...
      <div aria-hidden="true" className="absolute -bottom-16 -right-16 w-80 h-80 md:-bottom-24 md:-right-24 md:w-[26rem] md:h-[26rem] bg-card rounded-full opacity-90 z-0 shadow-lg"></div>
      <div aria-hidden="true" className="absolute -bottom-12 -right-12 w-60 h-60 md:-bottom-16 md:-right-16 md:w-[20rem] md:h-[20rem] bg-accent rounded-full z-10 shadow-xl"></div>
    </footer>
  );
}
