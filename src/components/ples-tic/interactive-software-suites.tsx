    ...
    "GestorDoc": {
        ...
        items: [
           { name: "Administración de Consultas", slug: "gestordoc-consultas", description: "Gestión de solicitudes de consulta de documentos.", details: {
                mainIcon: HelpCircle,
                title: 'MÓDULO ADMINISTRACIÓN DE CONSULTAS',
            ...
            { name: "Gestión de Formatos y TRD", slug: "gestordoc-formatos", description: "Organización y clasificación documental.", details: {
                ...
                keyServices: [
                  { title: 'Series y Subseries', text: 'Organice los documentos en conjuntos lógicos para facilitar su clasificación y recuperación dentro del sistema.', icon: Layers },
                  { title: 'Tabla de Retención Documental (TRD)', text: 'Establezca plazos de conservación y disposición final de los documentos cumpliendo con la regulación.', icon: Timer },
                  { title: 'Tipos de Documento y Registro FUID', text: 'Asigne un identificador único (FUID) a cada documento para garantizar su unicidad y seguimiento.', icon: Barcode },
            ...
            { name: "Administración del Sistema", slug: "gestordoc-sistemas", description: "Control de acceso y seguridad.", details: {
                ...
                keyServices: [
                  ...
                  { title: 'Gestión de Permisos y Acceso', text: 'Determine qué acciones puede realizar cada usuario y configure políticas de seguridad.', icon: Lock },
                  { title: 'Administración de Dependencias', text: 'Facilite la gestión y configuración de las dependencias entre diferentes áreas o unidades organizativas.', icon: GitBranch }
                ],
                benefits: [
